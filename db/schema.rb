...
ActiveRecord::Schema.define(version: 2019_01_31_185723) do
  ...
  create_table "stroll_dog_joins", force: :cascade do |t|
    t.integer "dog_id"
    t.integer "stroll_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["dog_id"], name: "index_stroll_dog_joins_on_dog_id"
    t.index ["stroll_id"], name: "index_stroll_dog_joins_on_stroll_id"
  end
